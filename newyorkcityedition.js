...
square[4] = new Square("Cpajak Tax", "PAY 10% OR $200", "white");
...
square[30] = new Square("Gopenjara", "Go directly to Jail. Do not pass GO. Do not collect $200.", "white");
square[31] = new Square("T Hotel", "$300", "green", 300, 9, 26, 130, 390, 900, 1100, 1275);
square[32] = new Square("Essex House", "$300", "green", 300, 9, 26, 130, 390, 900, 1100, 1275);
square[33] = new Square("CChest", "FOLLOW INSTRUCTIONS ON TOP CARD", "white");
square[34] = new Square("Th", "$320", "green", 320, 9, 28, 150, 450, 1000, 1200, 1400);
square[35] = new Square("Uni", "$200", "white", 200, 1);
square[36] = new Square("Chance", "NEW YORK LOTTERY GAMES", "white");
square[37] = new Square("aku adalah.", "$350", "blue", 350, 10, 35, 175, 500, 1100, 1300, 1500);
square[38] = new Square("pranata", "Pay $75", "white");
square[39] = new Square("herry sofyandy", "$400", "blue", 400, 10, 50, 200, 600, 1400, 1700, 2000);
